...
python release/build_mvp_packages.py --version v1.1.5
python release/build_release_bundle.py --version 1.1.5
...
python release/sign_release_artifacts.py --version v1.1.5 --write-checksums --verify-checksums
```
...
```powershell
python release/sign_release_artifacts.py --version v1.1.5 --sign --target all --gpg-key-id <fingerprint>
```

Verify before upload:

```powershell
python release/sign_release_artifacts.py --version v1.1.5 --verify-checksums --verify-signatures --target all
```

Dry-run the signing commands when GPG is not available on the current machine:

```powershell
python release/sign_release_artifacts.py --version v1.1.5 --sign --target all --dry-run
```
