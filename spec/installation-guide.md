...
device configuration packs for the current `v1.1.18` release baseline and
...
```text
python release/build_mvp_packages.py --version v1.1.18
python release/build_release_bundle.py --version 1.1.18
