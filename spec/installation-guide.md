...
device configuration packs for the current `v1.1.21` release baseline and
...
```text
python release/build_mvp_packages.py --version v1.1.21
python release/build_release_bundle.py --version 1.1.21
python tools/build_release_package.py --manifest release/zmeta-release-manifest.yaml --output-dir release/package-v1.1.21 --release-id zmeta-v1.1.21 --release-state formal_release --no-signatures --release-notes release/RELEASE_NOTES_v1.1.21.md
python tools/validate_release_package.py --manifest release/zmeta-release-manifest.yaml --package-dir release/package-v1.1.21
```
