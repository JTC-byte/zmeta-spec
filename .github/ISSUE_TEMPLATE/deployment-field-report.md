...
<!-- Share public-safe information only: no credentials, private endpoints,
     coordinates of interest, or deployment-identifying details you would not
     publish. See the sharing posture in IP_POLICY.md. -->

**Deployment shape** (sensors/modalities, transports, profiles L/M/H,
encodings, egress targets)
...
**What did not** (fields you had nowhere honest to put, rules that fought
